...
- **Resolve**: append the answer under an `## Answer` heading, set `Status: resolved`, then append a context pointer—gist and link—to the map’s Decisions-so-far section.
